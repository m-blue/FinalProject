        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(RadioCheck(selectedTime1,selectedTime2,selectedTime3,selectedTime4)){
                    ...
                    nextScreen.putExtra("txtFirstName",firstName);
                    nextScreen.putExtra("txtLastName",lastName);
                    nextScreen.putExtra("txtPhone",phone);
                    nextScreen.putExtra("txtBirthDate",birthDate);
